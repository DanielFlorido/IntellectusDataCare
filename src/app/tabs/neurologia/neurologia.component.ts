...
import { NeuConclusionesComponent } from "../../forms/neurologiaForms/neu-conclusiones/neu-conclusiones.component";

@Component({
  selector: 'app-neurologia',
  standalone: true,
  imports: [NeuIsquemiaHachinskiComponent, NeuForm1Component, NeuIfsComponent, NeuConclusionesComponent],
